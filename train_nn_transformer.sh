...
python script/train_nn_model_by_site_transformer_relatvie_pos_label_CLS.py  # encode postion embedding as relative postion to target, ex: -3, -2, -1, (target site)0, 1, 2, 3 , add CLS
